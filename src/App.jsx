...
function App() {
  return (
    <div className='flex w-full inter'>
      <div className='fixed flex justify-between w-full h-12 bg-white shadow-sm'>

        <div className='flex items-center h-full space-x-2 cursor-pointer'>
        ...
        <div className='flex items-center'>
          <span className='flex items-center h-full px-4 hover:bg-neutral-100 cursor-pointer'>Log In</span>
          <button className='flex items-center space-x-2 mx-1 px-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-sm h-10'><span>Get Started</span> <span><FontAwesomeIcon icon={faArrowRight} /></span></button>
        </div>
      ...
      <div className='flex items-center flex-col w-full pt-12'>
        <div className='flex flex-col w-full items-center py-20 bg-neutral-900 space-y-16'>
          ...
          <span className='flex w-full justify-center space-x-4 pt-2'>
            <button className='flex items-center px-8 py-3 bg-green-500 hover:bg-green-600 text-white text-xl font-semibold rounded-sm'>Get Started</button>
            <button className='flex items-center px-8 py-3 bg-neutral-600 hover:bg-neutral-700 text-white text-xl font-semibold rounded-sm'>Learn More</button>
          </span>
        </div>
        ...
        <div className='flex w-full bg-neutral-900'>
          <div className='flex flex-col items-start w-1/2 p-16 space-y-8'>
            ...
            <button className='flex items-center px-8 py-3 space-x-3 bg-neutral-600 hover:bg-neutral-700 text-white text-xl font-semibold rounded-sm'> <span>Get Started Today</span> <span><FontAwesomeIcon icon={faArrowRight} /> </span></button>
          </div>
